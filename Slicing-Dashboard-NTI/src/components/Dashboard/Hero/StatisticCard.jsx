      ...
      <AnimatedCard
        ...
        skeleton={
          <div className="space-y-3">
            <SkeletonHeaderStat />
            <SkeletonChart className="h-48 lg:h-56 xl:h-64 2xl:h-72" />
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <img
            src={iconTelkomsel}
            alt="Icon Telkomsel"
            className="w-8 h-8 lg:w-9 lg:h-9 xl:w-10 xl:h-10 2xl:w-12 2xl:h-12 border border-zinc-200 rounded-xl"
          />
        ...
        <div className="h-48 lg:h-56 xl:h-64 2xl:h-72 mt-3">
          {isError ? (
            <ErrorState message="Gagal memuat grafik statistik FMC." />
          ) : (
        ...
        {/* Footer */}
        <div className="flex items-center gap-3 mt-3 p-2 xl:p-3 2xl:p-3 bg-slate-100 rounded-2xl border border-slate-300">
          ...
          <div>
            <p className="text-xs lg:text-xs xl:text-sm 2xl:text-sm">
              Growth Potential: 8.2M FBB-Only and 145.2M MBB-Only users available
              for FMC
            </p>
          </div>
        </div>
