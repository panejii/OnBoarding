...
const StatisticCard = () => {
  ...
  return (
    <div className="flex flex-col rounded-2xl bg-white p-2 lg:p-3 xl:p-4 2xl:p-5 shadow-sm h-full">
      ...
      {/* Statis, tidak tergantung fetch -> langsung tampil, tidak ikut skeleton */}
      ...
      {/* Satu-satunya bagian yang benar-benar bergantung ke chartData (hasil fetch) */}
      <AnimatedCard
        isLoading={isLoading}
        className="h-48 lg:h-56 xl:h-64 2xl:h-72 mt-3"
