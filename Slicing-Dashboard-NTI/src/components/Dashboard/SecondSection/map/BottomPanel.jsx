  ...
  return (
    <div className="absolute bottom-4 left-4 right-4 bg-white rounded-xl shadow-md p-2 z-10">
      ...
      <div className="flex gap-1 mb-2">
        <button className="bg-violet-600 text-white px-2 py-1 2xl:py-2 rounded-lg text-[6px] 2xl:text-[10px]">
          Most Concern Grid
        </button>

        <button className="bg-gray-100 px-4 py-1 2xl:py-2 rounded-lg text-[6px] 2xl:text-[10px]">
          Problem Device
        </button>
      </div>
